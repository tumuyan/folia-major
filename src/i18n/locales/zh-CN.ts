...
export default {
  ...
  "options": {
    ...
    "temperaExportImages": "导出",
    "temperaImportReplaceImages": "替换导入",
    "temperaImportAppendImages": "追加导入",
    ...
    "temperaLayerImageUnsupported": "{{count}} 个文件不是图片池支持的格式",
    "temperaPoolImported": "已导入 {{count}} 张图片",
    "temperaPoolImportSkipped": "跳过 {{count}} 个无效文件",
