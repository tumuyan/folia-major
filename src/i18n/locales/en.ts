...
export default {
  ...
  "options": {
    ...
    "temperaExportImages": "Export",
    "temperaImportReplaceImages": "Import (replace)",
    "temperaImportAppendImages": "Import (append)",
    ...
    "temperaLayerImageUnsupported": "{{count}} file(s) are not images this pool accepts",
    "temperaPoolImported": "Imported {{count}} image(s)",
    "temperaPoolImportSkipped": "Skipped {{count}} unusable file(s)",
