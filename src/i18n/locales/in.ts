...
export default {
  ...
  "remote": {
    ...
    "temperaExportImages": "Ekspor",
    "temperaImportReplaceImages": "Impor (ganti)",
    "temperaImportAppendImages": "Impor (tambah)",
    ...
    "temperaLayerImagesAdded": "Menambahkan {{count}} gambar",
    "temperaLayerImageUnsupported": "{{count}} berkas bukan gambar yang diterima kolam ini",
    "temperaPoolImported": "Mengimpor {{count}} gambar",
    "temperaPoolImportSkipped": "Melewati {{count}} berkas yang tidak dapat dipakai",
